...
class HomeController extends GetxController {
  ...
  var isLoading = false.obs; // Observable for loading state of addTeam operation
  ...
  Future<void> addTeam(String teamName) async {
    ...
    try {
      if (teamName.trim().isEmpty) {
        Get.snackbar('Validation Error', 'Team name cannot be empty.', snackPosition: SnackPosition.BOTTOM);
      ...
      Get.snackbar('Success', 'Team "$teamName" added successfully!', snackPosition: SnackPosition.BOTTOM);
    } catch (e) {
      Get.snackbar(
        'Error',
